defmodule OpentelemetryAvalanche do
  ...
  @tracer_id :opentelemetry_avalanche

  @default_config [
    span_name: "avalanche.query",
  ...
  @doc """
  Attaches the OpentelemetryAvalanche handler to your Avalanche events. This should be called
