defmodule OpenTelemetryAvalancheTest do
  ...
  test "captures basic query events" do
    ...
    OpentelemetryAvalanche.teardown()
  end

  test "captures query params if options configured" do
    OpentelemetryAvalanche.setup(trace_query_params: true)
  ...
  test "ignores query errors if options configured" do
    OpentelemetryAvalanche.setup(trace_query_error: false)
