defmodule OpentelemetryAvalanche.MixProject do
  use Mix.Project

  @name "OpentelemetryAvalanche"
  @source_url "https://github.com/HGInsights/opentelemetry_avalanche"
  ...
  defp description do
    "Trace Avalanche (Snowflake) queries with OpenTelemetry."
  end
